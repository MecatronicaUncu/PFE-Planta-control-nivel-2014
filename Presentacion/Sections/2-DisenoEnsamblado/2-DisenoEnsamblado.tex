...
\includegraphics[width=6cm]{Sections/2-DisenoEnsamblado/Images/pyid60-1.pdf}
	\end{center}
	\begin{itemize}
		\item {\color{newcolor} Codificación}:
		\begin{itemize}
			\item Primer letra: Designa la variable medida.
...
\frame{
	...
	{\color{newcolor} Necesidad:} Generar un flujo de agua ininterrumpido entre 
	el reservorio y el tanque controlado.

	\begin{columns}
	 \begin{column}{.35\textwidth}
	 Bombas centrífugas funcionando constantemente.
	 \end{column}
