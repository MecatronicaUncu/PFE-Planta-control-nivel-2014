...
disponibles en el Laboratorio de Control Automático\todo{ver precios de todos
los elementos}:
\begin{itemize}
  ...
  extremos, de $160\,mm$ de diámetro. Ver sección \ref{sec:Tanques}.
...
\begin{itemize}
\item 30 \todo{verificar} metros de cañería adicional, que sirven como tiempo
muerto.
