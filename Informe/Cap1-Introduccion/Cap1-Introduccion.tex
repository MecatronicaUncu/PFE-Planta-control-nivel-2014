...
se encuentran en la industria, tales como transmisores de señal diferenciales de presión
...
Además, se utilizará una válvula globo, con servoactuador de diafragma - resorte
...
electroposionador neumático:} marca Foxboro, modelo
  ...
  \item \textbf{DP cells (2):} transmisores de señal de presión
...
\begin{itemize}
 ...
 colocará la válvula globo y la placa orificio (junto
...
programable (\gls{plc}).
El electroposionador neumático de la válvula globo, el comando de las
electrobombas y los transmisores de señal de presión
