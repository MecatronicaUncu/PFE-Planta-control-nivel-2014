...
En la Fig. \ref{fig:fotoTablero} \todo{incluir una foto del tablero}se muestra
...
\item En el nivel inferior está la fuente de alimentación de $24\,V$ (Sec.
\ref{subsec:fuenteAlim}) y el
\gls{plc}, con su módulo de E/S analógicas (Sec. \ref{subsec:plc}).
\end{itemize}
