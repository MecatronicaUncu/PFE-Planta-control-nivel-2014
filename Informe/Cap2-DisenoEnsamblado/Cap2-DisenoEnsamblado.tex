...
\label{sec:Tanques}
  ...
  la cañería deberá colocarse dentro de la estructura de soporte.
  Por ende, los tanques se ubicaron en los extremos, sobre las barras de 
  refuerzo.
...
\section{Bombas}
\label{sec:Bombas}
  se colocaron las bombas lo más cerca posible de los respectivos tanques. 
