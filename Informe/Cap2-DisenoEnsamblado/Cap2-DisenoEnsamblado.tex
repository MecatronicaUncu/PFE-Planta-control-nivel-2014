...
No obstante, se observa que el valor de $C_q$ varia poco con $Re$ ($7\,\%$
aproximadamente), y depende fundamentalmente de $\beta$.
...
la diferencia de alturas $\sqrt{h_f}$, que puede
...
abierta, y se midió el tiempo $t$ necesario para que el nivel alcanzara la
altura $l$.
Ya que el tanque tiene un diámetro $D=0.2\,m$ el caudal máximo puede ser
calculado como
\begin{align}
 Q_{max} &= \dfrac{\pi\,D^2\,l}{4\,t}
\end{align}

Ya que el módulo analógico del \gls{plc} tiene una resolución de $12\,bits$
(ver sección \ref{subsec:plc}), un valor de caudal máximo corresponde $h_f =
4095$.\todo{Puglesi 4096}
$K$ se calcula como
\begin{align}
...
Se marcó en el tanque controlado una altura $l=xxx\,m$.
