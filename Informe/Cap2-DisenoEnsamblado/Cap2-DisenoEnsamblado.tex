...
esquema, que puede encontrarse en la imagen \ref{img:p&id}.

\begin{figure}
	\centering
	\includegraphics[]
	{Cap2-DisenoEnsamblado/images/p&id.pdf}
...
retorno.
 \item Se obtiene mediante lectura en el DP cell el valor del la presión $h_p$,
y se calcula el caudal correspondiente.
 \item Se cambia la posición de la válvula. Se repite 3 a 5.
\end{enumerate}
