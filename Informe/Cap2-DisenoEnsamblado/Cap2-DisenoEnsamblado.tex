...
\begin{figure}[t]
 \centering
 \includegraphics{Cap2-DisenoEnsamblado/images/PG-EPL.pdf}
 \caption{Esquema de funcionamiento, posicionador electroneumático.}
 \label{fig:elp-funcionamiento}
\end{figure}

En la figura \ref{fig:elp-funcionamiento} se muestra el esquema de
...
\subsection{Característica efectiva de la válvula}

Para poder realizar el gráfico característico de la válvula se realizaron 
los siguientes pasos:

\begin{enumerate}
 \item Se fija el nivel de los tanques al 50\%.
 \item Se realiza una apertura progresiva de la válvula en intervalos de
 10\%, desde el 0\%, totalmente cerrada, hasta el 100\%, totalmente abierta.
 \item Se activan los motores.
 \item Se toma la medición una vez estabilizado el caudal.
\end{enumerate}

Los resultados del gráfico de la válvula sin tiempo muerto se pueden observar
en la figura \ref{graf:valvula}, en tanto que el gráfico de la válvula para
la planta trabajando con tiempo muerto se puede observar en la figura 
\ref{graf:valvulatiempomuerto}.
...
constatar la presencia del efecto de flujo estrangulado o Chocked Flow por su 
traducción al ingles. En el mismo se observa que el parámetro que se limita es 
la velocidad del fluido.

Es una condición dinámica del fluido asociada con el efecto Venturi. Cuando un flujo
de fluido a una presión y temperatura dada pasa a través de una restricción, como
una garganta, una zona convergente/divergente o una válvula, mientras que disminuye
la presión la velocidad del fluido aumenta.
...
En el gráfico \ref{graf:valvula} se observa que sobre el 70 \% de apertura de la 
válvula el caudal no se incrementó significativamente.
