...
de las tuberías que forman el sistema (material y diámetros).
...
La gestión de alarmas se realiza a través del transmisor de señal de nivel presente en la
planta,
tomando la información del mismo para detener el sistema en caso de pasar
los límites normales de trabajo.
Este proceso debería realizarse utilizando transmisores de señal separados (redundancia).
No obstante, debido al costo de incluir transmisores de señal suplementarios,
se decidió utilizar
directamente el transmisor de señal de nivel presente.
...
niples).
La tubería se torna compleja, dificultando la comprensión del circuito
...
\begin{itemize}
  ...
  se utilizo manguera flexible dado que la estructura no permitía colocar tubos
...
Por ultimo se procedió a pintar los tubos mediante un código de colores.
 \begin{itemize}
...
controlado.
El transmisor de señal de nivel tardará un tiempo adicional $t_d$ en observar los cambios
...
tiempo muerto.
La inclusión de esta tubería adicional permite disponer de dos escenarios
...
esférica plástica permite activar la tubería de tiempo muerto.
  ...
  Al abrirla, nada impide que el fluido circule por las dos tuberías al mismo
tiempo.
...
Se conectan a esta tubería la celda de presión diferencial y una manguera
...
\begin{figure}[ht]
  \centering
  \begin{tikzpicture}[scale= 0.08, domain=0:110]
...
Se denomina \textit{DP Cell}, o celda de presión diferencial, a un transmisor de señal
...
de la tubería, con la consiguiente aceleración del fluido.
...
las tuberías de llenado y vaciado, las mangueras de conexión, el tiempo muerto y
los tanques.

\begin{figure}[h!]
	\centering
\includegraphics[width=.85\textwidth]{Cap2-DisenoEnsamblado/images/IMG_5123.JPG}
