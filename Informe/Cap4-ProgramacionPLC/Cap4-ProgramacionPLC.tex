...
peldaño).
La ejecución de los peldaños es secuencial, comenzando por \verb|RUNG 0|.
...
La figura \ref{fig:ladder} muestra un diagrama de los diferentes peldaños de
nuestro programa de aplicación.
Se observa que la estructura secuencial del algoritmo \ref{img:algoritmo} ha
sido respetada en los peldaños.\todo{comparar Ladder y algoritmo con el programa
final buscando discrepancias}
...
\hline
Esc & \verb|MW1| & \verb|X0|& Switch Encender(1)/Apagar(0)(era 
\verb|MW0:X10|)\\
Esc & & \verb|X1|& Manual(1)/Automático(0) (era \verb|MW0:X15|)\\
Esc & & \verb|X2|& Cambiar parámetros PID (era \verb|MW0:X9|)\\
Esc & & \verb|X3|& Cambiar Set Point (era
\verb|MW0:X7|)\\
Esc & & \verb|X4|& Manual(0)/Default(1) (era \verb|MW0:X8|)\\
Esc & & \verb|X5|& Encender M1 (manual) (era \verb|MW8:X1|)\\
Esc & & \verb|X6|& Encender M2 (manual) (era \verb|MW8:X2|)\\
Esc & & \verb|X7|& Limpiar errores (era \verb|MW8:X0|)\\
\hline
\end{tabular}
...
Esta salida no está conectada.\todo{En anexo, diagrama ladder de twido soft}
...
Se realizó el método experimental, obteniéndose...\todo{hacer ZN}.

\section{Comunicación}
\label{sec:Comunicacion}

Tal como se mencionó anteriormente, sólo los \gls{memoryWord} (palabras) pueden
