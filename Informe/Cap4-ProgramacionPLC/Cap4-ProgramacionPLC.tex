...
\gls{plc}. En el Anexo \ref{anexo:programaLadder} se encuentra el programa en 
Ladder que corre en el   \gls{plc} de la planta.
...
El \gls{plc} puede guardar información de diversa índole en memoria, por 
ejemplo valores binarios.
...
Representan valores numéricos de $16$ bits de resolución, es decir de $0$ a 
$65536$. En ellos puede guardarse información numérica
...
Se corroboran estos datos en la Fig. \ref{fig:oscilacionperm}.

\begin{figure}[ht]
 \centering
 \includegraphics[scale=0.4]{Cap4-ProgramacionPLC/images/oscperm.png}
 \caption{Gráfico de la planta sin tiempo muerto.}
...
En la Fig. \ref{fig:controlado} se puede apreciar laimagen de la planta
funcionandocon estos valores de ganancias.

\begin{figure}[ht]
 \centering
 \includegraphics[scale=0.4]{Cap4-ProgramacionPLC/images/controlado.png}
 \caption{Gráfico de la planta controlada sin tiempo muerto.}
...
Se corroboran estos datos en la Fig. \ref{fig:oscilacionpermtd}.

\begin{figure}[ht]
 \centering
 \includegraphics[scale=0.4]{Cap4-ProgramacionPLC/images/oscpermtd.png}
 \caption{Gráfico de los valores de la planta.}
...
En la Fig. \ref{fig:controladotd} se puede apreciar laimagen de la planta
funcionandocon estos valores de ganancias.
