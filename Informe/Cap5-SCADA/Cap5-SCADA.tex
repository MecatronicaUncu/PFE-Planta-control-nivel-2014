...
Teniendo en cuenta estos aspectos y las variables establecidas en el \gls{plc} 
para la comunicación con el \gls{scada} (Ver tabla)\todo{agregar la tabla de 
variables PLCs} podemos definir los siguientes 3 grandes grupos de bloques con 
...
%  la base de datos. Es necesario definir variables internas del \gsl{scada} 
% para ser utilizadas para lectura/escritura de la \gls{hmi}.
