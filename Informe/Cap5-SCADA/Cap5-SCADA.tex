...
Ahora se puede controlar el funcionamiento del bloque recién configurado de la 
siguiente manera:
\begin{enumerate}
...
será utilizada en este \gls{pfe} unicamente como \gls{hmi}. Para el
...
%       Para poder probar el funcionamiento de la \gls{hmi} procedemos de la
%	siguiente manera:
%       \begin{enumerate}
%        \item 
%       \end{enumerate}
