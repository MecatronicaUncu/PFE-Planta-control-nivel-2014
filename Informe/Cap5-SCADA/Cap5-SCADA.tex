...
mediante el \gls{scada}, esto último será detallado en la 
Sec.\ref{anexo:operacionSCADA} 
del Manual del Usuario que se encuentra en los anexos. 
...
software P-CIM. Su exposición esta dividida de acuerdo a la estructura en capas 
...
comunicación con el \gls{plc} que controla la planta. Esta tarea se alcanza por 
medio de alguno de los múltiples buses de comunicación que existen en el 
