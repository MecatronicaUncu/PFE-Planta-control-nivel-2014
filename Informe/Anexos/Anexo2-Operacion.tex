...
se encuentra bien configurada y que el sistema \gls{scada} es capas de 
intercambiar información. Proceda como se describe a continuación:
\begin{table}[!ht]
\centering
\renewcommand*{\arraystretch}{0.01}
\begin{tabular}{*{2}{m{0.45\textwidth}}}
...
Finalmente, para controlar el sistema desde el \gls{scada} de P-CIM de AFCON, 
...
Pueden diferenciarse los siguientes bloques principales (Ver 
Fig.\ref{fig:hmiscada2})
\begin{figure}[!ht]
	\centering
...
\begin{enumerate}
\item \textbf{Parada de Emergencia:} Mediante este botón se para totalmente la 
planta y solo volvera a responde si se presiona \textbf{Rehabilitar Sistema}.
...
Puede seleccionar el valor por Default(50\%) o Manual. Pulse Aplicar para que 
...
\item {Elementos Gráficos}: En ellos se pueden observar los valores actuales e 
historicos de nivel de ambos tanques. También se señalan las alarmas de nivel y 
sus valores.
\end{enumerate}
